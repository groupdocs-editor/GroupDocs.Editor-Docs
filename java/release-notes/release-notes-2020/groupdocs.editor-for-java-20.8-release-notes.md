...
You can find more info about this feature in the article "[Adding class name to input controls]({{< ref "editor/java/developer-guide/edit-word/adding-class-name-to-input-controls.md" >}})".
